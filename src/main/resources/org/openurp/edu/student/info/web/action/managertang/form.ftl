...
[@b.form action="!save" name="studentForm" theme="list"]
   ...
   [@b.textfield name="student.nationality" label="国籍" value=(student.nationality)! check="maxLength(100)" required="true"/]
   [@b.textfield name="student.passportNo" label="护照号" value=(student.passportNo)! check="maxLength(100)" required="true" /]
   [@b.datepicker name="student.birthday" label="出生日期" value=(student.birthday)! required="true" /]
   [@b.textfield name="student.major" label="专业" value=(student.major)! check="maxLength(100)" required="true"/]
   ...
   [@b.textfield name="student.classes" label="班级" value=(student.classes)! check="maxLength(100)" required="false" disabled=true style="color: gray;"/]
   [@b.textfield name="student.landlord" label="房东电话" value=(student.landlord)! check="maxLength(100)" required="false" disabled=true style="color: gray;"/]
